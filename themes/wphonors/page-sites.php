...
<div id="content" class="inner clearfix">
	<div id="content-main">
		...
		query_posts( array( 'post_type' => 'site', 'caller_get_posts' => -1, 'orderby' => 'rand', 'paged' => $paged ) );
		...
		?>
			...
			<div id="site-<?php the_ID(); ?>" class="sites clearfix user_id_<?php the_author_meta('ID'); ?>">
				
				<div class="site-thumbnail">
					<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo $a[1]; ?>" alt="<?php the_title(); ?>" width="200" /></a>
...
<a name="fb_share" type="button_count" share_url="<?php the_permalink();?>" href="http://www.facebook.com/sharer.php">Share</a>
	...
	<div id="message message_404">
		...
		<p>There are no sites posted yet...</p>
	</div>
	<?php endif; ?>
