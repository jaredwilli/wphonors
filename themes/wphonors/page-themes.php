...
<div id="content" class="inner clearfix">
	<div id="content-main">
		...
		<?php query_posts( array( 'post_type' => 'theme', 'caller_get_posts' => -1, 'orderby' => 'rand', 'paged' => $paged ) ); ?>
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		<?php $t = new TypeThemes(); $c = $t->themeshot(200); ?>

			<div id="theme-<?php the_ID(); ?>" class="sites clearfix user_id_<?php the_author_meta('ID'); ?>">

			<div class="site-thumbnail">
				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo $c[1]; ?>" alt="<?php the_title(); ?>" width="200" /></a>
