...
<div id="content" class="inner clearfix">
	...
	<?php $pl = new TypePlugins(); $b = $pl->pluginshot(400); ?>

		<div id="plugin-<?php the_ID(); ?>" class="sites clearfix">
...
<a name="fb_share" type="button_count" share_url="<?php the_permalink();?>" href="http://www.facebook.com/sharer.php">Share</a>
			...
			<h1 class="post-title"><?= ucwords(get_post_type())?> Entry <a href="<?php echo $b[0]; ?>"><?php the_title(); ?></a></h1>
